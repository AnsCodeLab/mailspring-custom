...
class ToolbarWindowControls extends react_1.default.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement(roving_tab_index_toolbar_1.RovingTabIndexToolbar, { label: (0, mailspring_exports_1.localized)('Window Controls'), className: `toolbar-window-controls alt-${this.state.alt}` },
...
class ToolbarMenuControl extends react_1.default.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", { className: "toolbar-menu-control" },
