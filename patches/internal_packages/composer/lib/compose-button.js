...
class ComposeButton extends react_1.default.Component {
    ...
    render() {
        return (react_1.default.createElement("button", { className: "btn btn-toolbar item-compose", style: { order: -200 }, title: (0, mailspring_exports_1.localized)('Compose new message'), "aria-label": (0, mailspring_exports_1.localized)('Compose new message'), onClick: this._onNewCompose },
